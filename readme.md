...
- **1:** [FOLLOW](https://links.samples.com/lin) Ranga on LinkedIn

## Check Out Our Amazing ROADMAPS

- **1:** [AWS Roadmap](https://github.com/samples/roadmaps/blob/main/README.md#aws-roadmap)
- **2:** [Azure Roadmap](https://github.com/samples/roadmaps/blob/main/README.md#azure-roadmap)
- **3:** [Google Cloud Roadmap](https://github.com/samples/roadmaps/blob/main/README.md#google-cloud-roadmap)
- **4:** [Cloud Beginner Roadmap](https://github.com/samples/roadmaps/blob/main/README.md#cloud-beginner-roadmap)
- **5:** [DevOps Roadmap](https://github.com/samples/roadmaps/blob/main/README.md#devops-roadmap)
- **6:** [Java Full Stack Roadmap](https://github.com/samples/roadmaps/blob/main/README.md#java-full-stack-roadmap)
- **7:** [Java Microservices Roadmap](https://github.com/samples/roadmaps/blob/main/README.md#java-microservices-roadmap)
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <groupId>com.samples.springboot</groupId>
...
### /src/main/java/com/samples/springboot/controller/StudentController.java
...
### /src/main/java/com/samples/springboot/model/Course.java

```java
package com.samples.springboot.model;
...
### /src/main/java/com/samples/springboot/model/Student.java
...
### /src/main/java/com/samples/springboot/service/StudentService.java
...
### /src/main/java/com/samples/springboot/StudentServicesApplication.java
...
### /src/test/java/com/samples/springboot/controller/StudentControllerTest.java
...
### /src/test/java/com/samples/springboot/StudentServicesApplicationTests.java
